...
It is useful to display both the number of observations, and the ignorance score, which here we calculate using the visitations. First, create the colour pallete based on the number of visits:
...
palBW <- leaflet::colorNumeric(pallete = "Blues", 
...
Now create the visitation map, using this colour pallete for legend
